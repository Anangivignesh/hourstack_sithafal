...
const config: Config = {
  ...
  content: [
    ...
    './frontend/store/**/*.{js,ts,jsx,tsx,mdx}',
    './frontend/app/**/**/*.{js,ts,jsx,tsx,mdx}',
    './electron-agent/src/**/*.{js,ts,jsx,tsx}',
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-glassmorphic': 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.05) 100%)',
      },
      backdropBlur: {
        xs: '2px',
        sm: '4px',
